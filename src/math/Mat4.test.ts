...
describe("Mat4", () => {
  ...
  it("should return a correctly oriented camera matrix", () => {
    ...
    // Test the resulting matrix against a manually calculated result
    const expected = new Mat4([
      0.9486832980505139, -0.16903085094570333, 0.2672612419124244, 0, 0,
      0.8451542547285167, 0.5345224838248488, 0, -0.31622776601683794,
      -0.50709255283711, 0.8017837257372732, 0, -1, -2, -3, 1,
    ]);
