...
export function Search() {
  ...
  const searchIcon = (
    ...
    >
      <path
        ...
        fill="#6B7176"
      />
      <circle cx="5.5" cy="5.5" r="4.5" stroke="#6B7176" strokeWidth="2" />
    </svg>
  );
  ...
  const triggerButton = (
    <button
      className={twMerge(
        outline,
        "relative flex h-8 flex-1 shrink-0 cursor-pointer items-center rounded-md border border-mauvedark5 bg-mauvedark2 px-2 text-sm text-mauvedark10 hover:bg-mauvedark3",
      )}
    >
      Search...
      <SearchKeys />
  ...
  const resultsSection = results.map((result) => {
    return (
      <Link
        ...
        className={twMerge(
          outline,
          "block overflow-hidden rounded-md border border-mauvedark6 px-4 py-3 text-mauvedark12 hover:bg-mauvedark3",
        )}
      >
          ...
          >
            ...
            <div className="relative">
              <input
                ...
                className={twMerge(
                  outline,
                  "relative flex h-8 w-full shrink-0 items-center rounded-md border border-mauvedark5 bg-mauvedark1 px-2 text-sm text-mauvedark12 placeholder:text-mauvedark10",
                )}
                placeholder="Search…"
                onChange={onChange}
                value={search}
