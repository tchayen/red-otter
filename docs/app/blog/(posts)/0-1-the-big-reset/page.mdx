...
Supports clicks, scrolling, typing. The model is simplified in comparison to DOM and doesn't handle bubbling, it's just the top-most component that receives the event.
