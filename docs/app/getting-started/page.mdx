...
**TODO: accordion/details/spoiler component for collapsing this by default.**

**TODO: starter for other renderers (uh first add more of them?).**

<Tabs.Root>
  <Tabs.Tab name="WebGPU">123</Tabs.Tab>
  <Tabs.Tab name="WebGL">456</Tabs.Tab>
</Tabs.Root>
